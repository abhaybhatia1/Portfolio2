...
const Pro = ({ project, onClose }) => {
  ...
  return (
    <div className="max-w-[85vw] mx-auto p-6 bg-white rounded-lg shadow-md relative">
      <button
        onClick={onClose}
        className="absolute top-4 left-4 px-4 py-2 bg-gray-50 shadow-md text-gray-800 rounded hover:scale-105 transition duration-300 z-10"
      >
        Go Back
      </button>
      <div className="lg:hidden">
        <br /><br /><br /> {/* Add line breaks only on mobile */}
      </div>
